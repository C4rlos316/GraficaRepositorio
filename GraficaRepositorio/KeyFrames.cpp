...
typedef struct _frame {
	...
	float tail;
	float tailInc;
	// Rotación de patas delanteras
	float FLegs;
	float FLegsInc;
	// Rotación de patas traseras
	float RLegs;
	float RLegsInc;
...
void saveFrame(void)
{
	...
	FrameIndex++;  // Incrementar índice para el siguiente keyframe
}
...
void resetElements(void)
{
	...
	// Restaurar rotaciones iniciales
...
void interpolation(void)
{
	...
	// Calcular incrementos de rotaciones
...
int main()
{
	...
	for (int i = 0; i < MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].incY = 0;
		KeyFrame[i].incZ = 0;
		// Inicializar rotación del cuerpo
		KeyFrame[i].rotDog = 0;
		KeyFrame[i].rotDogInc = 0;
		// Inicializar rotación de cabeza
		KeyFrame[i].head = 0;
		KeyFrame[i].headInc = 0;
		// Inicializar rotación de cola
		KeyFrame[i].tail = 0;
		KeyFrame[i].tailInc = 0;
		// Inicializar patas delanteras
		KeyFrame[i].FLegs = 0;
		KeyFrame[i].FLegsInc = 0;
		// Inicializar patas traseras
		KeyFrame[i].RLegs = 0;
...
void Animation() {
	if (play)
	{
		...
		else
		{
			...
			// Aplicar incrementos a las rotaciones
