...
//posicion 2
glm::vec3 lightPos2(1.5f, 1.5f, 2.5f);

float movelightPos = 0.0f;

//movimiento posicion2
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 0.2f, 0.1f, 0.1f); 
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.8f, 0.2f, 0.2f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 1.0f, 0.0f, 0.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.5f, 0.5f, 1.0f);
